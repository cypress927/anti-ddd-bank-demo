 ...
 */
public record AccountFact(AccountNo accountNo, String name, Amount balance) {
    ...
    public static AccountFact unsaved(String name) {
        return new AccountFact(null, name, Amount.ZERO);
    }

    public AccountFact withAccountNo(AccountNo no) {
        return new AccountFact(no, this.name, this.balance);
    }

    public AccountFact withBalance(Amount newBalance) {
        return new AccountFact(this.accountNo, this.name, newBalance);
    }
}
